...
(define-test remove-piece
  (let* ((state (make-state :board (make-test-board-with '((1 1 :man :white))))))
...
(define-test apply-move
  (let* ((test-board-designator '((1 1 :man :white)
                                  ...
                                  (2 3 :man :black)
                                  (3 4 :man :white)))
         (state (make-state :board (make-test-board-with test-board-designator) :player :white))
         (breadcrumbs '()))
  ...
  (let ((state (read-from-string
                "#S(STATE :BOARD #2A((#S(TILE :OBJECT :VOID :OWNER NIL)
                             ...
                             (#S(TILE :OBJECT :VOID :OWNER NIL)
                              ...
                              #S(TILE :OBJECT :EMPTY :OWNER NIL)
                              #S(TILE :OBJECT :KING :OWNER :BLACK)
                              #S(TILE :OBJECT :EMPTY :OWNER NIL)
                              #S(TILE :OBJECT :EMPTY :OWNER NIL)
                              #S(TILE :OBJECT :VOID :OWNER NIL)
                              #S(TILE :OBJECT :VOID :OWNER NIL)
